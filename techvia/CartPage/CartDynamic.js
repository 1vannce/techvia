...
var philippinesData = {
    ...
    'Albay': ['Legazpi City', 'Tabaco City', 'Ligao City', 'Guinobatan', 'Daraga', 'Camalig'],
    'Bataan': ['Balanga City', 'Mariveles', 'Limay', 'Orani', 'Dinalupihan', 'Hermosa'],
    'Batangas': ['Batangas City', 'Lipa', 'Tanauan', 'Santo Tomas', 'Taal', 'Nasugbu', 'Mabini', 'Balayan'],
    'Benguet': ['Baguio City', 'La Trinidad', 'Itogon', 'Tuba', 'Sablan', 'Atok'],
    'Bohol': ['Tagbilaran City', 'Panglao', 'Dauis', 'Loboc', 'Carmen', 'Tubigon'],
    'Bukidnon': ['Malaybalay City', 'Valencia City', 'Manolo Fortich', 'Maramag', 'Don Carlos', 'Quezon'],
    'Bulacan': ['Malolos', 'Meycauayan', 'San Jose del Monte', 'Marilao', 'Bocaue', 'Santa Maria', 'Balagtas', 'Plaridel'],
    'Camarines Sur': ['Naga City', 'Iriga City', 'Pili', 'Calabanga', 'Goa', 'Nabua'],
    'Capiz': ['Roxas City', 'Panay', 'Dao', 'Mambusao', 'Pilar', 'Jamindan'],
    'Cavite': ['Bacoor', 'Dasmariñas', 'Imus', 'General Trias', 'Tagaytay', 'Trece Martires', 'Cavite City', 'Kawit', 'Silang'],
    'Cebu': ['Cebu City', 'Mandaue City', 'Lapu-Lapu City', 'Talisay City', 'Toledo City', 'Danao City', 'Carcar City', 'Naga', 'Bogo'],
    'Davao de Oro': ['Nabunturan', 'Monkayo', 'Compostela', 'Maco', 'Pantukan', 'Laak'],
    'Davao del Norte': ['Tagum City', 'Panabo City', 'Samal', 'Sto. Tomas', 'Kapalong'],
    'Davao del Sur': ['Davao City', 'Digos City', 'Santa Cruz', 'Malalag', 'Padada', 'Bansalan'],
    'Davao Oriental': ['Mati City', 'Lupon', 'Baganga', 'Manay', 'Cateel'],
    'Ifugao': ['Lagawe', 'Lamut', 'Banaue', 'Kiangan', 'Mayoyao'],
    'Ilocos Norte': ['Laoag City', 'Batac City', 'San Nicolas', 'Paoay', 'Dingras'],
    'Ilocos Sur': ['Vigan City', 'Candon City', 'Santa Cruz', 'Narvacan', 'Sinait'],
    'Iloilo': ['Iloilo City', 'Passi', 'Oton', 'Pavia', 'Leganes', 'Santa Barbara', 'Cabatuan', 'Pototan'],
    'Kalinga': ['Tabuk City', 'Rizal', 'Tinglayan', 'Lubuagan', 'Pasil'],
    'Laguna': ['Santa Rosa', 'Biñan', 'San Pedro', 'Calamba', 'Cabuyao', 'San Pablo', 'Santa Cruz', 'Los Baños', 'Pagsanjan'],
    'La Union': ['San Fernando City', 'Agoo', 'Bauang', 'Naguilian', 'Caba'],
    'Metro Manila': ['Manila', 'Quezon City', 'Makati', 'Taguig', 'Pasig', 'Pasay', 'Caloocan', 'Las Piñas', 'Muntinlupa', 'Marikina', 'Mandaluyong', 'Parañaque', 'San Juan', 'Malabon', 'Navotas', 'Valenzuela', 'Pateros'],
    'Misamis Occidental': ['Oroquieta City', 'Ozamiz City', 'Tangub City', 'Plaridel', 'Calamba'],
    'Misamis Oriental': ['Cagayan de Oro City', 'Gingoog City', 'El Salvador City', 'Jasaan', 'Opol', 'Claveria'],
    'Negros Occidental': ['Bacolod City', 'Bago City', 'Cadiz City', 'San Carlos City', 'Silay City', 'Talisay City', 'Victorias City', 'Kabankalan City'],
    'Negros Oriental': ['Dumaguete City', 'Bais City', 'Guihulngan', 'Tanjay', 'Bayawan City', 'Sibulan'],
    'Nueva Ecija': ['Cabanatuan City', 'San Jose City', 'Gapan City', 'Muñoz', 'Palayan City', 'Santa Rosa', 'Guimba'],
    'Occidental Mindoro': ['Mamburao', 'San Jose', 'Sablayan', 'Abra de Ilog', 'Lubang'],
    'Oriental Mindoro': ['Calapan City', 'Pinamalayan', 'Roxas', 'Naujan', 'Puerto Galera'],
    'Palawan': ['Puerto Princesa City', 'Coron', 'El Nido', 'Taytay', 'Brooke\'s Point', 'Busuanga'],
    'Pampanga': ['San Fernando', 'Angeles City', 'Mabalacat', 'Guagua', 'Lubao', 'Mexico', 'Porac', 'Arayat'],
    'Pangasinan': ['Dagupan City', 'Urdaneta City', 'San Carlos City', 'Alaminos City', 'Lingayen', 'Malasiqui'],
    'Quezon': ['Lucena City', 'Tayabas', 'Candelaria', 'Sariaya', 'Tiaong', 'Gumaca', 'Infanta'],
    ...
    'Zambales': ['Olongapo City', 'Subic', 'Iba', 'Botolan', 'Masinloc', 'San Marcelino']
};
...
function updateEditHeaderState() {
    ...
    var checked = document.querySelectorAll('.item-selector input[type="checkbox"]:checked');
...
function handleEditHeaderClick() {
    ...
    var selectedCheckboxes = document.querySelectorAll('.item-selector input[type="checkbox"]');

    if (action === 'EDIT') {
        isEditMode = true;
        for (var i = 0; i < selectedCheckboxes.length; i++) selectedCheckboxes[i].checked = false;
        ...
        var checkedCheckboxes = document.querySelectorAll('.item-selector input[type="checkbox"]:checked');
        itemsToDelete = [];
...
function renderCart() {
    ...
    if (currentCart.length === 0) {
        cartItemsContainer.innerHTML = '<p style="color: #999; padding: 20px; text-align: center;">Your cart is empty.</p>';
        return;
    }
    ...
    for (var i = 0; i < currentCart.length; i++) {
        ...
        itemElement.innerHTML = ''
            ...
            + '</div>'
            + '<div class="item-price">' + formatPrice(productData.price) + '</div>'
...
function updateCheckoutSummary() {
    var currentCart = getCart();
    var selectedCheckboxes = document.querySelectorAll('.item-selector input[type="checkbox"]:checked');
    ...
    for (var i = 0; i < selectedCheckboxes.length; i++) {
        ...
        if (foundItem) {
            ...
            selectedItems.push({ name: productData.name, subtotal: formatPrice(itemSubtotal) });
        }
    }
    ...
    if (selectedItems.length > 0) {
        for (var k = 0; k < selectedItems.length; k++) {
            ...
            detailItem.innerHTML = '<span>' + selectedItems[k].name + '</span><span>' + selectedItems[k].subtotal + '</span>';
            productDetails.appendChild(detailItem);
        }
    } else {
        productDetails.innerHTML = '<p style="color: #999; font-size: 12px;">No items selected</p>';
    }
    ...
    if (shippingSubtotalEl) shippingSubtotalEl.textContent = formatPrice(currentShippingFee);

    var isAddressValid = (userData.firstname !== 'Firstname' || userData.phone !== '0000000000');
    var hasSelectedItems = (selectedItems.length > 0);
    var isPaymentValid = validatePaymentMethod();

    placeOrderBtn.disabled = !(isAddressValid && hasSelectedItems && isPaymentValid);
...
function validatePaymentMethod() {
    ...
    if (currentPaymentMethod === 'bank') {
        var cardNumber = document.getElementById('cardNumber').value.trim().replace(/\s/g, '');
...
function showShippingView() {
    ...
    document.getElementById('firstname').value = (userData.firstname === 'Firstname') ? '' : userData.firstname;
    document.getElementById('lastname').value = (userData.lastname === 'Lastname') ? '' : userData.lastname;
    document.getElementById('email').value = userData.email;
    document.getElementById('phone').value = (userData.phone === '0000000000') ? '' : userData.phone;
...
if (editAddressLink) editAddressLink.addEventListener('click', showShippingView);
...
if (shippingForm) {
    shippingForm.addEventListener('submit', function (e) {
        ...
        userData.firstname = document.getElementById('firstname').value.trim() || 'Firstname';
        userData.lastname = document.getElementById('lastname').value.trim() || 'Lastname';
        userData.email = document.getElementById('email').value.trim();
        userData.phone = document.getElementById('phone').value.trim() || '0000000000';
